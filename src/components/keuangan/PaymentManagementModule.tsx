...
export const PaymentManagementModule: React.FC<{ embedded?: boolean }> = ({ embedded = false }) => {
  const {
    biayaMasterList,
    addBiayaMaster,
    updateBiayaMaster,
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      {!embedded && <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col lg:flex-row lg:items-center justify-between gap-5">
