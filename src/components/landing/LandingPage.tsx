            ...
            <div className="bg-white/10 backdrop-blur-md p-5 sm:p-8 lg:p-10 rounded-3xl sm:rounded-[2.5rem] border border-white/20 text-white space-y-4 sm:space-y-6 max-w-lg w-full shadow-2xl">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-white/20">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-[#1ABC9C] flex items-center justify-center text-white font-bold text-2xl shadow-lg">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
            ...
            <div className="bg-[#F8FAFC] p-8 sm:p-10 rounded-3xl border border-gray-200 hover:border-[#1A5276] transition-all hover:shadow-xl flex flex-col justify-between">
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="font-black text-xl sm:text-2xl text-[#1A5276]">1. Portal Admin & Pengelola</h3>
                  <p className="text-xs sm:text-sm text-[#566573] mt-2 leading-relaxed">Akses penuh untuk staf tata usaha, bendahara, & pengasuhan.</p>
                </div>
            ...
            {/* Guru Card */}
            <div className="bg-[#F8FAFC] p-8 sm:p-10 rounded-3xl border border-gray-200 hover:border-[#2E86C1] transition-all hover:shadow-xl flex flex-col justify-between">
              <div className="space-y-6">
            ...
            {/* Wali Card */}
            <div className="bg-[#F8FAFC] p-8 sm:p-10 rounded-3xl border border-gray-200 hover:border-[#1ABC9C] transition-all hover:shadow-xl flex flex-col justify-between">
              <div className="space-y-6">
